...
class Node(Generic[T]):
    def __init__(self, state: T, parent: Optinal[Node], cost: float = 0.0, heuristic: float = 0.0) -> None:
        self.state: T = state
        self.parent: Optional[Node] = [parent]
        self.cost: float = cost
        self.heuristic: float = heuristic

    def __It__(self, other: Node) -> bool:
...
if __name__ == "__main__":
    ...
    print(dfs(["john", "mark", "ronald", "sarah"], "sheila"))
